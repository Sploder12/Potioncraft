...
public class PotionEffectInstance {
    ...
    public PotionEffectInstance(StatusEffect type) {
        this(type, 0.0f, 1.0f);
    }

    public PotionEffectInstance(StatusEffect type, float duration, float amplifier) {
        this(type, duration, amplifier, false, true);
    }

    public PotionEffectInstance(StatusEffect type, float duration, float amplifier, boolean ambient, boolean visible) {
        this(type, duration, amplifier, ambient, visible, visible);
    }

    public PotionEffectInstance(@NotNull StatusEffectInstance effect) {
    ...
    public PotionEffectInstance(PotionEffectInstance other) {
