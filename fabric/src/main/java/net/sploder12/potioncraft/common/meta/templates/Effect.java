...
import net.sploder12.potioncraft.common.PotionEffectInstance;
...
public interface Effect {
    ...
    MetaEffectTemplate PLAY_SOUND = (params, file) -> {
        ...
        Log.warn("PLAY_SOUND effect has invalid id field! " + file);
    ...
    MetaEffectTemplate ADD_STATUS_EFFECT = (params, file) -> {
        ...
        Log.warn("ADD_POTION_EFFECT effect has invalid id field! " + file);
        return Conditional.PASS.apply(params, file);
    };
    ...
    MetaEffectTemplate SET_FLUID = (params, file) -> {
        ...
        return (ActionResult prev, CauldronData data, World world, BlockPos pos, PlayerEntity player, Hand hand, ItemStack stack) -> {
            if (new_fluid == null) {
                Log.warn("SET_FLUID effect has invalid fluid identifier! " + file);
                return ActionResult.PASS;
            }
