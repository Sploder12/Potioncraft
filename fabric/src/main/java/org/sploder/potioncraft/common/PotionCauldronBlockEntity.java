...
public class PotionCauldronBlockEntity extends BlockEntity {
    ...
    public static void register(BlockEntityType<PotionCauldronBlockEntity> entity) {
        Log.debug("Registering Potion Cauldron Block Entity...");

        POTION_CAULDRON_BLOCK_ENTITY = entity;
    ...
    public boolean invertEffects() {
        ...
        for (var effect : this.effects.values()) {
            if (MetaMixing.inversionMapping.has(effect.type)) {
                changed = true;
                effect.type = MetaMixing.inversionMapping.get(effect.type);
            }
