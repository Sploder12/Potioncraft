...
import static org.sploder.potioncraft.common.meta.MetaMixing.interactions;
...
public class PotionCauldronBlock extends AbstractCauldronBlock implements BlockEntityProvider {
    ...
    public static final PotionCauldronBlock POTION_CAULDRON_BLOCK = new PotionCauldronBlock(
            AbstractBlock.Settings.copy(Blocks.CAULDRON).luminance(
    ...
    public static void register() {
        Log.debug("Registering Potion Cauldron...");
        ...
        Registry.register(
                Registries.ITEM,
                POTION_CAULDRON_ID,
                new BlockItem(POTION_CAULDRON_BLOCK, new Item.Settings()));

        PotionCauldronBlockEntity.register(Common.instance.getPotionCauldronBlockEntity());
    }

    public static Map<Item, CauldronBehavior> getBehaviorMap(AbstractCauldronBlock id) {
        if (id == null) {
            return null;
        }
    ...
    public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
        ...
        if (!world.isClient()) {
            ...
            if (blockEntity instanceof PotionCauldronBlockEntity cauldronEntity
                ...
                var behaviorMap = getBehaviorMap(POTION_CAULDRON_BLOCK);
